...
app.controller('trialController', ['$scope', '$http', '$routeParams', '$rootScope', function($scope, $http, $routeParams, $rootScope) {
    $scope.beddingMonths = ['jan', 'feb', 'mar', 'apr','may','jun', 'jul', 'aug', 'sep', 'oct', 'nov', 'dec'];
    $scope.pillowMonths = ['jan to mar', 'apr to jun', 'july to sep', 'oct to dec'];
    $scope.mattressMonths = ['jan to mar', 'apr to jun', 'july to sep', 'oct to dec'];
    $scope.carpetMonths = ['jan to jun', 'jul to dec'];
    $scope.pillowsMonths = ['jan to jun', 'jul to dec'];

    $scope.month_card = function(month, year) {
